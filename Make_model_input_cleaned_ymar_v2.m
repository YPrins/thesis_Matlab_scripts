...
batch       = 'Final_friction_60'; % Change this to the corresponding Chézy value
...
Cin    = 60;      % Chezy friction coefficient
...
title(sprintf('Bathymetry (Slope = %.3f, l_c = %d m)', ...
    Slopes(pp), lcAll(hh)))

legend('Bathymetry','Location','best')

set(gca,'YDir','reverse')

saveas(fig, fullfile(npath,'bathymetry.png'))

% Optional higher-resolution version
print(fig, fullfile(npath,'bathymetry'), '-dpng', '-r300')
